...
var _charRangeDefaults = {
  shilu:    [60, 120],    // 实录（★2026-08-12 省token:200-400→60-120 点睛级·完整账目由本地 _composeLocalTurnSummary 合成·AI 只写戏剧性点睛·render 落账合并）
  szj:      [250, 500],    // 时政记（T1385收敛：deepseek 慢输出专项·要事点化）
  houren:   [1500, 3500],  // 后人戏说（T1382收敛：Branch C 叙事压缩→生成加速）
  zw:       [400, 800],    // 兼容——旧"二次叙事"，逐步废弃
  memLoyal: [400, 600],    // 奏疏（谏章/忠臣）
  memNormal:[200, 350],    // 奏疏（普通）
  memSecret:[150, 250],    // 奏疏（密折）
  wd:       [120, 250],    // 问对回复
  cy:       [60, 120],     // 朝议发言·T1379 收敛(奏对短句犀利·防喰嗦)
