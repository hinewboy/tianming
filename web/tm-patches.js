  ...
  b.innerHTML=
    ...
    (function(){
      var _mechs = [
        ...
        ['sysPTieringEnabled','⚡ AI 省流·分级系统提示（默认开）','开启后，过回合的各专项子推演（财政/军事/势力/诏令/认知/快照）只携带各自任务所需的系统提示段落，而非整份剧本大提示——一回合可省大量输入 token（省钱且提速），主推演与对话不受影响。2026-08-10 起默认开启；若开启后出现人名地名错乱等异常，请关闭并反馈。'],
        ['skipOutlineReview','📜 叙事审查·大纲复核（默认关·跳过省时省钱）','开启后，过回合的叙事大纲会多一步 AI 复核（查时代错乱/人名错误/缺失节拍，temp=0.3，仅在确信时报告）——每回合多花约 15-25 秒与一个调用。默认关闭（跳过）：已有确定性亡者审计兜底，且大纲错误会在成文后由引擎校正。'],
